...
/**
 * A menu for getting the Begin State Probabilities
 * for an HMM
 * @author Brian J. Walters
 */
public class GetBeginStateProb extends AbstractView {
	Scanner scanner;
	List<String> states;
	Hashtable<String, Double> table;
	
	/**
	 * Creates a new Begin State menu.
	 * @param states	a list of states
	 */
	public GetBeginStateProb(List<String> states) {
	 ...
	 */
	private void getBeginStateProbabilities() {
		for (String state: states) {
			System.out.println("Enter begin state prob for " + state + ": ");
